	...
	"parse_iso8601 returns valid date&time for a general date and time format with decimal seconds")
{
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10:13.123Z");
		CHECK(ss.str() == "2020-08-13 23:10:13.123");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10:13.12Z");
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10:13.12345Z");
		CHECK(ss.str() == "2020-08-13 23:10:13.123");
	}
	// 'YYYY-MM-DDThh:mm:ss.sss'
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10:13.12345");
		CHECK(ss.str() == "2020-08-13 23:10:13.123");
	}
}
	...
	"parse_iso8601 returns valid date&time for a general date and time format with decimal minutes")
{
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10.5Z");
		CHECK(ss.str() == "2020-08-13 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10.50Z");
		CHECK(ss.str() == "2020-08-13 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10.500Z");
		CHECK(ss.str() == "2020-08-13 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10.5000Z");
		CHECK(ss.str() == "2020-08-13 23:10:30.000");
	}
	// 'YYYY-MM-DDThh:mm.mmm'
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2020-08-13T23:10.5000");
		CHECK(ss.str() == "2020-08-13 23:10:30.000");
	}
}
	...
	"parse_iso8601 returns valid date&time for a general date and time format with decimal hours")
{
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23.5Z");
		CHECK(ss.str() == "1989-10-05 23:30:00.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23.50Z");
		CHECK(ss.str() == "1989-10-05 23:30:00.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23.500Z");
		CHECK(ss.str() == "1989-10-05 23:30:00.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23.5000Z");
		CHECK(ss.str() == "1989-10-05 23:30:00.000");
	}
	// 'YYYY-MM-DDThh.hhh'
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23.50000");
		CHECK(ss.str() == "1989-10-05 23:30:00.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23");
...
TEST_CASE("parse_iso8601 returns valid date&time for comma decimal separator")
{
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10:13,123Z");
		CHECK(ss.str() == "1993-09-09 23:10:13.123");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10:13,12Z");
		CHECK(ss.str() == "1993-09-09 23:10:13.120");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10:13,1Z");
		CHECK(ss.str() == "1993-09-09 23:10:13.100");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10:13,12345Z");
		CHECK(ss.str() == "1993-09-09 23:10:13.123");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10:13,12345");
		CHECK(ss.str() == "1993-09-09 23:10:13.123");
	}

	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10,5Z");
		CHECK(ss.str() == "1993-09-09 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10,50Z");
		CHECK(ss.str() == "1993-09-09 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10,500Z");
		CHECK(ss.str() == "1993-09-09 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10,5000Z");
		CHECK(ss.str() == "1993-09-09 23:10:30.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1993-09-09T23:10,5000");
		CHECK(ss.str() == "1993-09-09 23:10:30.000");
	}
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1989-10-05T23,5000");
		CHECK(ss.str() == "1989-10-05 23:30:00.000");
	}
}
	...
	"parse_iso8601 returns valid date&time for a general date and time format without separators")
{
	{
		ostringstream ss;
		ss << parse_iso8601datetime("19700101T23:10:13Z");
		CHECK(ss.str() == "1970-01-01 23:10:13.000");
	}
	{
		ostringstream ss;
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("21200530T23:10:13Z");
		CHECK(ss.str() == "2120-05-30 23:10:13.000");
	}
}
...
TEST_CASE("parse_iso8601 returns valid date&time for a general date")
{
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01-01");
		CHECK(ss.str() == "1970-01-01 00:00:00.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("19700101");
		CHECK(ss.str() == "1970-01-01 00:00:00.000");
	}

	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01");
		CHECK(ss.str() == "1970-01-01 00:00:00.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("197001");
		CHECK(ss.str() == "1970-01-01 00:00:00.000");
	}
}
...
TEST_CASE("parse_iso8601 returns valid date&time for a given timezone offset")
{
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01-01T22:30:13+04:00");
		CHECK(ss.str() == "1970-01-01 18:30:13.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01-01T22:30:13+04");
		CHECK(ss.str() == "1970-01-01 18:30:13.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01-02T00:00:13+04");
	...
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1900-02-28T23:10:13-00:10");
		CHECK(ss.str() == "1900-02-28 23:20:13.000");
	}
	// minus sign U+2212
	{
		ostringstream ss;
		ss << parse_iso8601datetime(u8"1900-02-28T23:10:13\u221200:10");
		CHECK(ss.str() == "1900-02-28 23:20:13.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("2120-05-30T23:10:13+00:00");
		CHECK(ss.str() == "2120-05-30 23:10:13.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01-01T15:00:13-03:30");
		CHECK(ss.str() == "1970-01-01 18:30:13.000");
	}
	{
		ostringstream ss;
		ss << parse_iso8601datetime("1970-01-01T15:00:13-03");
...
{
	{
		CHECK_THROWS(parse_iso8601datetime("1970-13-01T23:10:13_00:30"));
	}
	{
		CHECK_THROWS(parse_iso8601datetime("1970-00-01T23:10:13_00:30"));
	}
	{
	...
	{
		CHECK_THROWS(parse_iso8601datetime("2000-02-29T23:10:13-00:30Z"));
	}
}
...
TEST_CASE("parse_iso8601 throws exception for invalid time offset")
{
	...
	{
		CHECK_THROWS(parse_iso8601datetime("1970-00-01T23:10:13+00:60"));
	}
	{
		CHECK_THROWS(parse_iso8601datetime("1970-01-35T23:10:13+14:30"));
	}
	{
		CHECK_THROWS(parse_iso8601datetime("1970-01-35T23:10:13-13:00"));
	}
	{
		CHECK_THROWS(parse_iso8601datetime("1970-01-35T23:10:13-12:30"));
	}
	{
		CHECK_THROWS(parse_iso8601datetime("1970-01-35T23:10:13/12:30"));
	}
	...
	{
		CHECK_THROWS(parse_iso8601datetime("1970-13-01T23:10:13+15"));
	}
	{
		CHECK_THROWS(parse_iso8601datetime("1970-01-35T23:10:13-13"));
	}
}
